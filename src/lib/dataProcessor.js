...
export const processData = (rawData) => {
    ...
    const summary = {
        ...
        delayedOrdersList: [],
        orderTypesOEM: {},
        ordersByForwardingAgent: {}, // <-- PŘIDÁNO
    };
    ...
    rawData.forEach(row => {
        ...
        const forwardingAgent = row["Forwarding agent name"] || "Neznámý";
        summary.ordersByForwardingAgent[forwardingAgent] = (summary.ordersByForwardingAgent[forwardingAgent] || 0) + 1;
