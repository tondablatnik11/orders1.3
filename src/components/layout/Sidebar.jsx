...
const Sidebar = forwardRef(({ activeTab, onTabChange }, ref) => {
    ...
    // Komponenta pro jednotlivé položky menu
    // Funkce onTabChange se volá při kliknutí a předává ID záložky rodiči
    const NavLink = ({ item }) => (
        <li
        ...
        <aside ref={ref} className="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-slate-800 text-white flex flex-col p-4 shadow-2xl">
            ...
            <div className="border-t border-slate-700 pt-4 mt-auto">
                <div className="flex items-center gap-3 px-2 py-2.5 rounded-lg">
                    ...
                    <button onClick={signOut} className="p-2 rounded-md hover:bg-slate-700 transition-colors" aria-label="Odhlásit se">
