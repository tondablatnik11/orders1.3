...
import { RefreshCw, Search, BarChart3, Users, AlertTriangle, UploadCloud } from 'lucide-react';
        ...
        <div className="p-0 md:p-4">
            ...
            {isLoadingErrorData ? (
                ...
                <div className="space-y-6">
                    ...
                    <Grid numItemsLg={5} className="gap-6">
                        ...
                        <Card className="lg:col-span-2">
                            ...
                            <BarChart 
                                className="mt-6 h-80"
                                data={errorData.chartsData.errorsByUser.slice(0, 10)} 
                                index="name" 
                                categories={['Počet chyb']} 
                                colors={['fuchsia']} 
                            />
                                ...
                                <tbody className="divide-y divide-gray-800">
                                    {filteredErrors.map((error, idx) => (
                                        <tr key={idx} className="hover:bg-gray-800/50">
                                            ...
                                            <td className={`p-3 whitespace-nowrap text-sm font-bold ${error.qtyDifference !== 0 ? 'text-amber-400' : 'text-gray-500'}`}>{error.qtyDifference}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                ...
                <div className="flex items-center justify-center h-[60vh] text-center">
                    <Text>Žádná data k zobrazení. <br />Zkuste aktualizovat nebo nahrát nový report chyb.</Text>
                </div>
            )}
        </div>
    );
