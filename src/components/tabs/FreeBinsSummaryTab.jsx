...
const ErrorState = ({ error }) => (
 <Card className="bg-red-900/20 border-red-700 text-red-400">
    <CardHeader>
      ...
      {/* CardDescription zde nepoužíváme */}
    </CardHeader>
    <CardContent>
...
const FreeBinsSummaryTab = () => {
  ...
  const fetchData = async () => {
    ...
    } catch (err) { console.error("Chyba při načítání sumárních dat:", err); setError(err.message); setSummaryData(null); }
  ...
  // Funkce pro vykreslení obsahu záložky
  const renderContent = () => {
