...
import { OverallOverview } from './analytics/OverallOverview';
import { ABCAnalysis } from './analytics/ABCAnalysis';
import { BinTypeByRowAnalysis } from './analytics/BinTypeByRowAnalysis';
...
export const WarehouseAnalyticsTab = ({ kpis, isLoading }) => {
    ...
    const renderContent = () => {
        switch(activeSubTab) {
            ...
            case 'bin_types': return <BinTypeByRowAnalysis kpis={kpis} />;
            default: return null;
        }
    };
    ...
    return (
        <div className="p-6 flex flex-col h-full">
            <div className="flex items-center gap-2 border-b border-border pb-4 mb-4 flex-wrap">
                ...
                <SubTabButton tabName="bin_types" label="Analýza Typů Míst po Řadách"/>
            </div>
